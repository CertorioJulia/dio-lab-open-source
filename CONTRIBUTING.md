...
| `raw`          | Indica mudanças relacionadas a arquivos de configurações.            | `raw: RAW Date of year yyyy"`
| `remove`       | Indica a exclusão de arquivos, diretórios ou funcionalidades.        | `remove: Removing unused files from the project to maintain organization and continuous updating"`
